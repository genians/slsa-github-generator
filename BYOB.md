...
```yaml
- uses: slsa-framework/slsa-github-generator/actions/delegator/setup-generic@v2.0.9
```
...
```yaml
- uses: slsa-framework/slsa-github-generator/.github/workflow/delegator_generic_slsa3.yml@v2.0.9
  with:
...
slsa-run:
  ...
  uses: slsa-framework/slsa-github-generator/.github/workflows/delegator_generic_slsa3.yml@v2.0.9
  with:
    slsa-token: ${{ needs.slsa-setup.outputs.slsa-token }}
  secrets:
