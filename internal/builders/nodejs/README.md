...
publish:
  ...
  steps:
    ...
    - name: publish
      id: publish
      uses: slsa-framework/slsa-github-generator/actions/nodejs/publish@v2.0.7
      with:
        access: public
  ...
  publish:
    ...
    steps:
      ...
      - name: Download provenance
        uses: slsa-framework/slsa-github-generator/actions/nodejs/secure-attestations-download@v2.0.7
        with:
