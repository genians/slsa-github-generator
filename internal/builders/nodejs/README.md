...
publish:
  ...
  steps:
    ...
    - name: publish
      id: publish
      uses: slsa-framework/slsa-github-generator/actions/nodejs/publish@v2.0.5
      with:
        access: public
  ...
  publish:
    ...
    steps:
      ...
      - name: Download tarball
        uses: slsa-framework/slsa-github-generator/actions/nodejs/secure-package-download@v2.0.5
        with:
